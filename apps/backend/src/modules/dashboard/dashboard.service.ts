...
export class DashboardService {
  ...
  async getOverview() {
    return this.cacheService.getOrSet('dashboard:overview', async () => {
      const [
        totalOrders,
        totalUsers,
        totalPromoters,
  ...
  async getDailyStats(days: number = 7) {
    return this.cacheService.getOrSet(`dashboard:daily:${days}`, async () => {
      const stats = [];
      const now = new Date();
  ...
  async getCategoryStats() {
    return this.cacheService.getOrSet('dashboard:category', async () => {
  ...
  async getPromoterRanking(limit: number = 10) {
    return this.cacheService.getOrSet(`dashboard:promoter:${limit}`, async () => {
  ...
  async getSupplierStats() {
    return this.cacheService.getOrSet('dashboard:supplier', async () => {
